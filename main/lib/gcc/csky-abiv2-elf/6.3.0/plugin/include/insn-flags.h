...
#define HAVE_doloop_end_internal_loop (CSKY_ISA_FEATURE(dspv2))
...
#define HAVE_untyped_call (TARGET_HARD_FLOAT_ABI)
...
#define HAVE_doloop_begin (CSKY_ISA_FEATURE(dspv2) && flag_csky_doloop)
#define HAVE_doloop_end (CSKY_ISA_FEATURE(dspv2) && flag_csky_doloop)
