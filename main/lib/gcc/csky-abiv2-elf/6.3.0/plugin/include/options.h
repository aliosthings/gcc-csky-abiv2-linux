...
enum opt_code
{
  ...
  OPT_mccrt = 1195,                          /* -mccrt */
  OPT_mconstpool = 1196,                     /* -mconstpool */
  OPT_mcp = 1197,                            /* -mcp */
  OPT_mcpu_ = 1198,                          /* -mcpu= */
  OPT_mdiv = 1199,                           /* -mdiv */
  OPT_mdoloop = 1200,                        /* -mdoloop */
  OPT_mdouble_float = 1201,                  /* -mdouble-float */
  OPT_mdsp = 1202,                           /* -mdsp */
  OPT_medsp = 1203,                          /* -medsp */
  OPT_melrw = 1204,                          /* -melrw */
  OPT_mfdivdu = 1205,                        /* -mfdivdu */
  OPT_mfloat_abi_ = 1206,                    /* -mfloat-abi= */
  /* OPT_mfloat_abi_v1 = 1207, */            /* -mfloat-abi=v1 */
  /* OPT_mfloat_abi_v2 = 1208, */            /* -mfloat-abi=v2 */
  OPT_mfpu_ = 1209,                          /* -mfpu= */
  /* OPT_mhard_float = 1210, */              /* -mhard-float */
  OPT_mhigh_registers = 1211,                /* -mhigh-registers */
  OPT_mistack = 1212,                        /* -mistack */
  OPT_mlittle_endian = 1213,                 /* -mlittle-endian */
  OPT_mmac = 1214,                           /* -mmac */
  OPT_mmp = 1215,                            /* -mmp */
  OPT_mmultiple_stld = 1216,                 /* -mmultiple-stld */
  OPT_mpushpop = 1217,                       /* -mpushpop */
  OPT_msmart = 1218,                         /* -msmart */
  /* OPT_msoft_float = 1219, */              /* -msoft-float */
  OPT_mstack_size = 1220,                    /* -mstack-size */
  /* OPT_mstm = 1221, */                     /* -mstm */
  OPT_mstrict_align = 1222,                  /* -mstrict-align */
  OPT_mtrust = 1223,                         /* -mtrust */
  ...
  OPT_pie = 1241,                            /* -pie */
  OPT_pipe = 1242,                           /* -pipe */
  OPT_print_file_name_ = 1243,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1244,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1245,          /* -print-multi-directory */
  OPT_print_multi_lib = 1246,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1247,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1248,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1249,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1250,               /* -print-prog-name= */
  OPT_print_search_dirs = 1251,              /* -print-search-dirs */
  OPT_print_sysroot = 1252,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1253,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1254,                          /* -quiet */
  OPT_r = 1255,                              /* -r */
  OPT_remap = 1256,                          /* -remap */
  OPT_s = 1257,                              /* -s */
  OPT_s_bc_abi = 1258,                       /* -s-bc-abi */
  OPT_save_temps = 1259,                     /* -save-temps */
  OPT_save_temps_ = 1260,                    /* -save-temps= */
  OPT_shared = 1261,                         /* -shared */
  OPT_shared_libgcc = 1262,                  /* -shared-libgcc */
  /* OPT_specs = 1263, */                    /* -specs */
  OPT_specs_ = 1264,                         /* -specs= */
  OPT_static = 1265,                         /* -static */
  OPT_static_libasan = 1266,                 /* -static-libasan */
  OPT_static_libgcc = 1267,                  /* -static-libgcc */
  OPT_static_libgcj = 1268,                  /* -static-libgcj */
  OPT_static_libgfortran = 1269,             /* -static-libgfortran */
  OPT_static_libgo = 1270,                   /* -static-libgo */
  OPT_static_liblsan = 1271,                 /* -static-liblsan */
  OPT_static_libmpx = 1272,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1273,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1274,               /* -static-libstdc++ */
  OPT_static_libtsan = 1275,                 /* -static-libtsan */
  OPT_static_libubsan = 1276,                /* -static-libubsan */
  /* OPT_std_c__03 = 1277, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1278, */                /* -std=c++0x */
  OPT_std_c__11 = 1279,                      /* -std=c++11 */
  OPT_std_c__14 = 1280,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1281, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1282, */                /* -std=c++1y */
  OPT_std_c__1z = 1283,                      /* -std=c++1z */
  OPT_std_c__98 = 1284,                      /* -std=c++98 */
  OPT_std_c11 = 1285,                        /* -std=c11 */
  /* OPT_std_c1x = 1286, */                  /* -std=c1x */
  /* OPT_std_c89 = 1287, */                  /* -std=c89 */
  OPT_std_c90 = 1288,                        /* -std=c90 */
  OPT_std_c99 = 1289,                        /* -std=c99 */
  /* OPT_std_c9x = 1290, */                  /* -std=c9x */
  OPT_std_f2003 = 1291,                      /* -std=f2003 */
  OPT_std_f2008 = 1292,                      /* -std=f2008 */
  OPT_std_f2008ts = 1293,                    /* -std=f2008ts */
  OPT_std_f95 = 1294,                        /* -std=f95 */
  OPT_std_gnu = 1295,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1296, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1297, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1298,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1299,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1300, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1301, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1302,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1303,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1304,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1305, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1306, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1307,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1308,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1309, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1310, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1311,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1312, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1313, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1314, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1315,                     /* -std=legacy */
  OPT_symbolic = 1316,                       /* -symbolic */
  OPT_t = 1317,                              /* -t */
  OPT_time = 1318,                           /* -time */
  OPT_time_ = 1319,                          /* -time= */
  OPT_traditional = 1320,                    /* -traditional */
  OPT_traditional_cpp = 1321,                /* -traditional-cpp */
  OPT_trigraphs = 1322,                      /* -trigraphs */
  OPT_u = 1323,                              /* -u */
  OPT_undef = 1324,                          /* -undef */
  OPT_v = 1325,                              /* -v */
  OPT_version = 1326,                        /* -version */
  OPT_w = 1327,                              /* -w */
  OPT_wrapper = 1328,                        /* -wrapper */
  OPT_x = 1329,                              /* -x */
  OPT_z = 1330,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
